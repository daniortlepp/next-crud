...
export default class ColecaoCliente implements ClienteRepositorio {
    ...
    #colecaoCliente = collection(firebase, 'clientes').withConverter(this.#conversor)
    ...
    //#colecao = collection(firebase, 'clientes').withConverter(this.#conversor)

    /*private colecao() {
        return firestore
            .collection(firebase, 'clientes')
